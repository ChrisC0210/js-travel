<template>
  ...
  <section class="bg-cus-gray flex justify-center align-center">
    <div class="container mt-14 mb-32">
      <div class="container flex justify-between">
        <div class="w-auto">
          ...
          >
            ...
            <h3
              ...
              class="text-slate-500 font-bold text-base text-center"
            >
        ...
        <div class="col-10 lg:col-6 w-2/12 h-auto flex-column">
          <div id="chart"></div>
        </div>
      </div>
      <!-- cards -->
            ...
            >
              <div class="flex-1 flex flex-col">
                ...
                <div class="p-6 flex-1">
                  ...
                  <h5 v-else class="text-2xl font-medium mb-2">無名稱</h5>
                  <hr class="border-2 border-primary mb-8 max-w-sm" />
                  <p
                    v-if="item.description"
                    class="text-base mb-4 line-clamp-3 text-slate-500"
                  >
                    {{ item.description }}
                  </p>
                ...
                >
                  <div class="text-base font-medium flex">
                    ...
                    <span v-if="item.group" class="ml-1">
                      剩下最後 {{ item.group }} 組
                    </span>
...
export default {
  components: { BeakerIcon, axios, d3, c3},
  data() {
    return {
      dataCard: [],
    }
